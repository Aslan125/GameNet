...
{
    /// <summary>
    /// Базовый класс для Net входящее сообщение и Net Outgoing Message
    /// </summary>
    public partial class NetBuffer
	{
        ...
        /// <summary>
        /// Считывает логическое значение (хранится в виде одного бита), написанный с использованием Write (BOOL)
        /// </summary>
        ...
        /// <summary>
        /// Читает байт и возвращает истину или ложь для достижения успеха
        /// </summary>
        ...
        /// <summary>
        /// Читает указанное количество байт и возвращает верно для успеха
        /// </summary>
        ...
        /// <summary>
        /// Читает указанное количество байт в массиве выделенную
        /// </summary>
        /// <param name="into">Массив назначения</param>
        /// <param name="offset">Смещение, где, чтобы начать писать в массиве назначения</param>
        /// <param name="numberOfBytes">Количество байт для чтения</param>
        ...
        /// <summary>
        /// Читает 16 разрядное целое число написано с использованием Write (Int16)
        /// </summary>
        ...
        /// <summary>
        /// Читает 16 бит целое без знака, написанные с использованием Write (UInt16)
        /// </summary>
        [CLSCompliant(false)]
        ...
        /// <summary>
        /// Читает 32 разрядное целое число написано с использованием Write (Int32)
        /// </summary>
        ...
        /// <summary>
        /// Читает 32 разрядное целое число, написанный с использованием Write (Int32).
        /// </summary>
        [CLSCompliant(false)]
        ...
        /// <summary>
        /// Читает целое число хранится в 1 до 32 бит, написанные с использованием Write (Int32, Int32)
        /// </summary>
        ...
        /// <summary>
        /// Читает 32 бит целое без знака, написанные с использованием Write (UInt32)
        /// </summary>
        [CLSCompliant(false)]
        ...
        /// <summary>
        /// Читает 32 разрядное число без знака, написанный с использованием Write (UInt32) и возвращает верно для успеха.
        /// </summary>
        [CLSCompliant(false)]
        ...
        /// <summary>
        /// Читает целое число без знака хранится в 1 до 32 бит, написанные с использованием Write (UInt32, Int32)
        /// </summary>
        [CLSCompliant(false)]
        ...
        /// <summary>
        /// Читает 64 бит целое без знака, написанные с использованием Write (Int64)
        /// </summary>
        [CLSCompliant(false)]
        ...
        /// <summary>
        /// Читает 64 разрядное целое число написано с использованием Write (Int64)
        /// </summary>
        ...
        /// <summary>
        /// Читает целое число без знака хранится в 1 до 64 бит, написанные с использованием Write (Int64, Int32)
        /// </summary>
        [CLSCompliant(false)]
        ...
        /// <summary>
        /// Читает целое число хранится в 1 до 64 бит, написанные с использованием Write (Int64, Int32)
        /// </summary>
        ...
        /// <summary>
        /// Читает 32 битное значение с плавающей точкой, написанные с использованием Write (Одноместный)
        /// </summary>
        ...
        /// <summary>
        /// Читает значение с плавающей запятой 32 бит, написанный с использованием Write (Single).
        /// </summary>
        ...
        /// <summary>
        /// Читает значение с плавающей запятой 64-битной, написанный с использованием Write (Double).
        /// </summary>
        ...
        /// <summary>
        /// Читает переменную размера UInt32 написаны с использованием переменных Написать UInt32 ().
        /// </summary>
        [CLSCompliant(false)]
        ...
        /// <summary>
        /// Читает переменную размера UInt32, написанный с использованием записи с переменной UInt32 () и возвращает верно для успеха
        /// </summary>
        [CLSCompliant(false)]
        ...
        /// <summary>
        /// Читает переменная размера Int32 написаны с использованием записи переменных Int32 ()
        /// </summary>
        ...
        /// <summary>
        /// Читает переменную размера UInt32, написанный с использованием записи переменных типа Int64 ()
        /// </summary>
        [CLSCompliant(false)]
        ...
        /// <summary>
        /// Читает 32 битное значение с плавающей запятой, написанный с использованием Написать Подписано Одноместные ()
        /// </summary>
        ...
        /// <summary>
        /// Читает 32 битное значение с плавающей запятой, написанный с использованием Написать единого блока ()
        /// </summary>
        /// <param name="numberOfBits">The number of bits used when writing the value</param>
