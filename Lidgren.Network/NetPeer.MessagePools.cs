...
namespace Lidgren.Network
{
	public partial class NetPeer
	{
        ...
        /// <summary>
        /// Создает новое сообщение для отправки.
        /// </summary>
        ...
        /// <summary>
        /// Создает новое сообщение для отправки и пишет предоставленную строку к нему.
        /// </summary>
        public NetOutgoingMessage CreateMessage(string content)
	        {
	            ...
	            {
	                om = CreateMessage(1); // Один байт для внутренней переменной-длина ноль байтов.
            }
	            else
	            {
        ...
        /// Создает новое сообщение для отправки.
        /// </summary>
        /// <param name="initialCapacity">Первоначальная мощность в байтах.</param>
        ...
        /// <summary>
        /// Перерабатывает чистую входящий экземпляр сообщение для повторного использования; снизить нагрузку на сборщик мусора.
        /// </summary>
        ...
        /// <summary>
        /// Перерабатывает список внутрисетевых входящих случаях Сообщение для повторного использования; снизить нагрузку на сборщик мусора.
        /// </summary>
        ...
        /// <summary>
        /// Создает входящее сообщение с требуемой мощности для освобождения от применения.
        /// </summary>
