...
{
    /// <summary>
    /// Большое число класса на основе BouncyCastle (http://www.bouncycastle.org) BigInteger кода.
    /// </summary>
    internal class NetBigInteger
	{
			...
			int radix)
		{
            ...
            //////
            // Мы могли бы выработать максимальное количество единиц, необходимое для хранения // str.length цифры в данном базы, то выделить, что // хранение одного удара ?, затем генерировать величину в один удар тоже?
            //////
