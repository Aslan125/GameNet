...
namespace Lidgren.Network
{
	public partial class NetConnection
	{
        ...
        /// <summary>
        /// Сообщение, что удаленная часть указанного через Connect() или Утвердить() - может быть NULL.
        /// </summary>
        public NetIncomingMessage RemoteHailMessage { get { return m_remoteHailMessage; } }

        // сердцебиение вызывается, когда соединение все еще находится в m_handshakes из NetPeer.
