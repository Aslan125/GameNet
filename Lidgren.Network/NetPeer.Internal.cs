...
namespace Lidgren.Network
{
	public partial class NetPeer
	{
        ...
        /// <summary>
        /// Получить Socket, если Star () был вызван.
        /// </summary>
        public Socket Socket { get { return m_socket; } }

        /// <summary>
        /// Назовем это зарегистрировать обратный вызов для, когда приходит новое сообщение.
        /// </summary>
        ...
        /// <summary>
        /// Позвоните, чтобы это отменить регистрацию обратного вызова, но не забудьте сделать это в том же SynchronizationContext!
        /// </summary>
        ...
        /// <summary>
        /// Если NetGear Configuration.AutoFlushSendQueue () является ложным; вам нужно позвонить, чтобы это отправить все сообщения в очереди, используя SendMessage ().
        /// </summary>
